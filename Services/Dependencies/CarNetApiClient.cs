...
namespace Services.Dependencies
{
    ...
    public partial class CarNetApiClient 
    {
        ...
        public System.Threading.Tasks.Task<Response> DetectAsync(int? box_offset, int? box_min_width, int? box_min_height, float? box_min_ratio, float? box_max_ratio, Box_select? box_select, System.Collections.Generic.IEnumerable<Anonymous> features, Region? region, System.IO.Stream body)
        {
        ...
        /// <returns>Image was successfully processed by API</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Response> DetectAsync(int? box_offset, int? box_min_width, int? box_min_height, float? box_min_ratio, float? box_max_ratio, Box_select? box_select, System.Collections.Generic.IEnumerable<Anonymous> features, Region? region, System.IO.Stream body, System.Threading.CancellationToken cancellationToken)
        {
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 401)
                        {
                            ...
                            throw new ApiException("Unauthorized access. You have to provide valid \'api-key\' header to access API", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 429)
                        {
    ...
    public partial class Parameters 
    {
        ...
        public float Box_max_ratio { get; set; }
        ...
        public float Box_min_ratio { get; set; }
